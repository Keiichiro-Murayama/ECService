...
public class JwtTokenProvider : IJwtTokenProvider
{
    ...
    public string IssueAccessToken(EmployeeAccount employeeAccount, IEnumerable<Claim>? extraClaims = null)
    {
        ...
        {
            [JwtRegisteredClaimNames.Sub] = employeeAccount.AccountUuid,
        };
